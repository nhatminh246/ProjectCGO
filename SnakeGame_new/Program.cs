...
namespace CGO_Buoi06_SnakeGame
{
    class Program
    {
        ...
        int bestscrore = 0, score, headX, headY, fruitX, fruitY, nTail, typeFruit;
        ...
        string dir, pre_dir, name = "None";
        string[] color_Fruit = {"BLue", "DarkYellow", "Magenta", "Cyan"};

        //Hien thi man hinh bat dau
        void ShowBanner()
        {
            Console.SetWindowSize(width+10, height +10+ panel); //height còn thêm thông báo panel
        ...
        void Logic()
        {
            ...
            {
                switch (dir){
                    case "LEFT": headX+=width-2; break;
                    case "RIGHT": headX-=width-2; break;
                    case "UP": headY+=height-2; break;
                    case "DOWN": headY-=height-2; break;
                }
            }
            else gameOver = false;
            ...
            {
                score += typeFruit*2+1; //tinh diem khi an qua !!!
        ...
        void Render()
        {
            ...
            for(int i=0; i< height; i++)
            {
                ...
                {
                    if (i == 0 || i == 20 - 1) //vien khung ben tren va duoi
                    {
                        Console.BackgroundColor = ConsoleColor.Gray  ;
                        Console.Write("#");
                        Console.BackgroundColor = ConsoleColor.Black;
                    }
                    else if (j == 0 || j == 60 - 1) //vien khung ben trai va phai
                    {
                        Console.BackgroundColor = ConsoleColor.Gray;
                        Console.Write("#");
                        Console.BackgroundColor = ConsoleColor.Black;
                    ...
                    {
                        string colorString = color_Fruit[typeFruit];
                    ...
                    {   //than con ran
                        ...
                        for (int k = 0; k < nTail; k++)
                        {
                            if (TailX[k] == j && TailY[k] == i)
                            {
                                Console.BackgroundColor = ConsoleColor.Red;
                                Console.Write("o");
                                Console.BackgroundColor = ConsoleColor.Black; //than con ran
                                isprinted = true;
                            }
                        }
            ...
            Console.WriteLine("Diem cao nhat: "+ bestscrore);
            Console.WriteLine("Nguoi choi diem cao nhat: "+ name);
        }
        //Xy ly game thua
        void Lose()
        {
            ...
            if(score > bestscrore){
                Console.WriteLine("Chuc mung ban da pha ky luc la "+ bestscrore );
                bestscrore = score;
